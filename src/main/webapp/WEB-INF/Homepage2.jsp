    ...
    <div class="row-2">
      ...
      <div class="left">
        <ul>
          ...
          <li><a href="park"><span style="color: red;">Logout</span></a></li>
          <li><a href="contact"><span style="color: red;">CONTACT</span></a></li>
          <li class="last"><a href="cancelbook" style="color: red;"><span>Cancel Booking</span></a></li>
        </ul>
      </div>
    </div>
...
<!--     <div class="extra"><img src="https://static.pexels.com/photos/170811/pexels-photo-170811.jpeg" alt="" " align="right"/></div> -->
    ...
    <div class="indent">
      <div class="wrapper">
        <div class="col-1">
          ...
          <div class="img-box1">
          <img src="C:/Program Files/apache-tomcat-8.0.22/webapps/demospring/WebContent/images/1page-img.jpg" alt="" />
            <p class="p0">
  ...
  <div id="footer">
    <div class="footer-nav">
      <div class="left">
        <ul>
         <li><a href="park" class="active"><span>HOME</span></a></li>
          <li><a href="Aboutus"><span>ABOUT</span></a></li>
          <li><a href="park"><span>Logout</span></a></li>
          <li><a href="contact"><span>CONTACT</span></a></li>
           <li><a href="cancel"><span>Cancel Booking</span></a></li>
        </ul>
      </div>
    </div>
